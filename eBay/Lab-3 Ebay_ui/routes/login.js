	...
	if(email === '' || password === '' || email === undefined || password === undefined){
		...
		soap.createClient(baseURL,option, function(err, client) {
		      if(err){
		    	  ...
		    	  client.verifyUser(params, function(err, result) {
		    		  console.log("In signin Method");
			    	  if(err){
			    		  console.log("Error in SOAP signin" + err);
			    	  }else{
			    		  if(result.verifyUserReturn == true){
...
exports.signup = function(req,res)
{
	...
	if(email === '' || password === '' || email === undefined || password === undefined){
		...
		var params = {email: email, password:encryptedPassword,fname:fname, lname:lname, lastLoginTime:lastLoginTime};
		console.log("params: " + params);
		soap.createClient(baseURL,option, function(err, client) {
		      if(err){
		    	  console.log("Error in SOAP Request" + err);
		      }else{
		    	  client.insertUser(params, function(err, result) {
		    		  console.log("In signup Method");
			    	  if(err){
			    		  console.log("Error in SOAP signup" + err);
			    	  }else{
